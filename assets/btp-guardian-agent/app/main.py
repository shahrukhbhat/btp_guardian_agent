...
def main(host: str, port: int):
    skill = AgentSkill(
        ...
        examples=["Which subaccounts have the highest cost this month?", "Show me all entitlements that are over 85% utilized", "Are there any governance policy violations in my BTP landscape?", "Give me a summary of my global account topology"],
    )
